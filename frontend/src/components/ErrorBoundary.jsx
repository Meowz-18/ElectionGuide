/**
 * @file Error boundary component for catching and gracefully displaying
 * runtime errors in the React component tree.
 */
    ...
    if (this.state.hasError) {
      return (
        <div
          role="alert"
          aria-live="assertive"
          className="flex h-full items-center justify-center p-8 bg-red-50"
        >
          <div className="max-w-md text-center">
            <h2 className="text-2xl font-bold text-red-700 mb-4">Something went wrong.</h2>
            <p className="text-red-600 mb-6">
              A module failed to load. Please try refreshing or navigating back to continue.
            </p>
